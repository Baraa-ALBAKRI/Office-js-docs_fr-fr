...
# <a name="bindings.getbyidasync-method"></a>Méthode Bindings.getByIdAsync
Obtient la liaison spécifiée par son identificateur.

|||
|:-----|:-----|
|**Hôtes :**|Access, Excel, Word|
|**Disponible dans l’[ensemble de conditions requises](../../docs/overview/specify-office-hosts-and-api-requirements.md)**|CustomXmlParts, MatrixBindings, TableBindings, TextBindings|
...
|:-----|:-----|:-----|:-----|
| _id_|**chaîne**|Spécifie le nom unique à utiliser pour identifier l’objet de liaison. Obligatoire.||
...
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Accéder à l’objet [Binding](../../reference/shared/binding.md) spécifié par le paramètre _id_ dans l’appel.|
...
Échoue si le paramètre _id_ spécifié n’existe pas.
...
|||
|:-----|:-----|
|**Disponible dans les ensembles de conditions requises**|CustomXmlParts, MatrixBindings, TableBindings, TextBindings|
