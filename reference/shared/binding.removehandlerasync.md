...
# <a name="binding.removehandlerasync-method"></a>Méthode Binding.removeHandlerAsync
...
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|Spécifie le type d’événement. Obligatoire.||
