...
# <a name="document.addhandlerasync-method"></a>Méthode Document.addHandlerAsync
Ajoute un gestionnaire d’événements pour un événement d’objet **Document**.

|||
|:-----|:-----|
|**Hôtes :**|Excel, PowerPoint, Project, Word|
|**Disponible dans l’[ensemble de conditions requises](../../docs/overview/specify-office-hosts-and-api-requirements.md)**|DocumentEvents|
|**Ajouté dans**|1.1|
...
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|Pour un événement d’objet **Document**, le paramètre _eventType_ peut être spécifié comme **Office.EventType.DocumentSelectionChanged** ou en tant que valeur de texte correspondante de cette énumération.||
| _handler_|**objet**|Fonction de gestionnaire d’événements à ajouter, dont le seul paramètre est de type [DocumentSelectionChangedEventArgs](../../reference/shared/document.selectionchangedeventargs.md). Obligatoire.||
...
|||
|:-----|:-----|
|**Disponible dans les ensembles de conditions requises**|DocumentEvents|
