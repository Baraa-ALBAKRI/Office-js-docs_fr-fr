...
# <a name="document.removehandlerasync-method"></a>Méthode Document.removeHandlerAsync
Supprime un gestionnaire d’événements pour un événement d’objet **Document**.
...
| _handler_|**objet**|Spécifie le nom du gestionnaire à supprimer. ||
...
L’exemple suivant permet de supprimer le gestionnaire d’événements nommé « MyHandler ».
