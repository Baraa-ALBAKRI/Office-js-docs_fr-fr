...
# <a name="nodeinsertedeventargs.newnode-property"></a>Propriété NodeInsertedEventArgs.newNode
Obtient le nœud qui vient d’être ajouté à l’objet **CustomXMLPart**.
...
[CustomXmlNode](../../reference/shared/customxmlnode.customxmlnode.md) qui représente le nœud qui vient d’être inséré.


## <a name="remarks"></a>Remarques

Notez que ce nœud peut avoir des enfants, si une sous-arborescence vient d’être ajoutée au document.
