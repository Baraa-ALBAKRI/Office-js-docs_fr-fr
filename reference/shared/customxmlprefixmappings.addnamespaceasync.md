...
# <a name="customxmlprefixmappings.addnamespaceasync-method"></a>Méthode CustomXmlPrefixMappings.addNamespaceAsync
Ajoute de manière asynchrone un préfixe au mappage d’espace de noms à utiliser lors de l’interrogation d’un élément.

|||
|:-----|:-----|
|**Hôtes :**|Word|
|**Disponible dans l’[ensemble de conditions requises](../../docs/overview/specify-office-hosts-and-api-requirements.md)**||
|**Ajouté dans**|1.1|
...
|:-----|:-----|:-----|:-----|
| _prefix_|**chaîne**|Spécifie le préfixe à ajouter à la liste de mappages de préfixes. Obligatoire.||
| _ns_|**chaîne**|Spécifie l’espace de noms à affecter au préfixe qui vient d’être ajouté. Obligatoire.||
...
Dans la fonction de rappel transmise à la méthode **addNamespaceAsync**, vous pouvez utiliser les propriétés de l’objet **AsyncResult** pour renvoyer les informations suivantes.
