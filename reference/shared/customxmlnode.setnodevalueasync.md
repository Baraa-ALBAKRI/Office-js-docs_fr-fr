...
# <a name="customxmlnode.setnodevalueasync-method"></a>Méthode CustomXmlNode.setNodeValueAsync
Définit de manière asynchrone la valeur du nœud.
...
|**[Ajouté](#support-history) dans**|1.1|
...
|:-----|:-----|:-----|:-----|
| _value_|**chaîne**|Valeur à affecter au nœud actuel. Obligatoire.||
...
Dans la fonction de rappel transmise à la méthode **setNodeValueAsync**, vous pouvez utiliser les propriétés de l’objet **AsyncResult** pour renvoyer les informations suivantes.
