...
# <a name="customxmlprefixmappings.getprefixasync-method"></a>Méthode CustomXmlPrefixMappings.getPrefixAsync
...
|:-----|:-----|:-----|:-----|
| _ns_|**chaîne**|Spécifie l’espace de noms dont le préfixe doit être obtenu. Obligatoire.||
...
Dans la fonction de rappel transmise à la méthode **getPrefixAsync**, vous pouvez utiliser les propriétés de l’objet **AsyncResult** pour renvoyer les informations suivantes.



|**Propriété**|**Utiliser pour**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Accéder à une **chaîne** qui contient le préfixe de l’espace de noms spécifié.|
