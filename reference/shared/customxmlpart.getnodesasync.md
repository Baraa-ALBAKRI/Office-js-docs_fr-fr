...
# <a name="customxmlpart.getnodesasync-method"></a>Méthode CustomXmlPart.getNodesAsync
...
|:-----|:-----|:-----|:-----|
| _xPath_|**chaîne**|Expression XPath qui spécifie les nœuds à retourner. Obligatoire.||
