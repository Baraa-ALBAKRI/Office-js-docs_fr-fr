...
# <a name="file.getsliceasync-method"></a>Méthode File.getSliceAsync
...
|**Niveau d’autorisation minimal**|[ReadDocument (ReadAllDocument requis pour obtenir Office OpenXML)](../../docs/develop/requesting-permissions-for-api-use-in-content-and-task-pane-add-ins.md)|
