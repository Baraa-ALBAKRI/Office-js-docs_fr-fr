...
# <a name="customxmlpart.getxmlasync-method"></a>Méthode CustomXmlPart.getXmlAsync
...
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Accéder à une **chaîne** qui contient les données XML de l’objet [CustomXmlPart](../../reference/shared/customxmlnode.getnodesasync.md) référencé.|
