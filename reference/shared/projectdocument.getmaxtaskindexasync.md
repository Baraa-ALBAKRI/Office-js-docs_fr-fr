...
# <a name="projectdocument.getmaxtaskindexasync-method"></a>Méthode ProjectDocument.getMaxTaskIndexAsync
Obtenez de façon asynchrone l’index maximal de la collection de tâches dans le projet en cours.
...
Pour la méthode **getMaxTaskIndexAsync**, l’objet [AsyncResult](../../reference/shared/asyncresult.md) renvoyé contient les propriétés suivantes :
...
|[value](../../reference/shared/asyncresult.value.md)|Nombre d’index maximal dans la collection de tâches du projet en cours.|

## <a name="remarks"></a>Remarques

Vous pouvez utiliser la valeur renvoyée avec la méthode [getTaskByIndexAsync](../../reference/shared/projectdocument.gettaskbyindexasync.md) pour obtenir les GUID de tâche. La tâche d’index 0 représente la tâche récapitulative de projet.


## <a name="example"></a>Exemple

L’exemple de code suivant appelle **getMaxTaskIndexAsync** pour obtenir l’index maximal de la collection de tâches dans le projet en cours. Ensuite, il utilise la valeur renvoyée avec la méthode [getTaskByIndexAsync](../../reference/shared/projectdocument.getselectedtaskasync.md) pour obtenir chaque GUID de tâche.
