...
# <a name="nodedeletedeventargs.isundoredo-property"></a>Propriété NodeDeletedEventArgs.isUndoRedo
Obtient des informations indiquant si le nœud a été supprimé dans le cadre d’une action Annuler/Rétablir effectuée par l’utilisateur.
...
Renvoie **true** si le nœud a été supprimé dans le cadre d’une action Annuler/Rétablir effectuée par l’utilisateur.
