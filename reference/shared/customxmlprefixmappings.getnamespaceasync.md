...
# <a name="customxmlprefixmappings.getnamespaceasync-method"></a>Méthode CustomXmlPrefixMappings.getNamespaceAsync
...
|:-----|:-----|:-----|:-----|
| _prefix_|**chaîne**|Spécifie le préfixe dont l’espace de noms doit être obtenu. Obligatoire.||
