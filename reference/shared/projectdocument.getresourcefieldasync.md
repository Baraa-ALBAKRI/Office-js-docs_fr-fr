...
# <a name="projectdocument.getresourcefieldasync-method"></a>Méthode ProjectDocument.getResourceFieldAsync
...
|:-----|:-----|:-----|:-----|
| _resourceId_|**chaîne**|GUID de la ressource. Obligatoire.||
