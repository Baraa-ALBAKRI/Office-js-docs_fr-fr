...
# <a name="customxmlnode.getnodevalueasync-method"></a>Méthode CustomXmlNode.getNodeValueAsync
Obtient de manière asynchrone la valeur du nœud.
...
Dans la fonction de rappel transmise à la méthode **getNodeValueAsync**, vous pouvez utiliser les propriétés de l’objet **AsyncResult** pour renvoyer les informations suivantes.



|**Propriété**|**Utiliser pour**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Accéder à une **chaîne** qui contient la valeur du nœud référencé.|
