...
# <a name="customxmlparts.getbyidasync-method"></a>Méthode CustomXmlParts.getByIdAsync
...
|:-----|:-----|:-----|:-----|
| _id_|**chaîne**|GUID de la partie XML personnalisée, incluant les accolades d’ouverture et de fermeture. Obligatoire.||
