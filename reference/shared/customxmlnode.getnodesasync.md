...
# <a name="customxmlnode.getnodesasync-method"></a>Méthode CustomXmlNode.getNodesAsync
Obtient les nœuds sous la forme d’un tableau d’objets **CustomXMLNode** correspondant à l’expression XPath relative.
...
|:-----|:-----|:-----|:-----|
| _xPath_|**chaîne**|Expression XPath qui spécifie les nœuds à obtenir. Obligatoire.||
...
Dans la fonction de rappel transmise à la méthode **getNodesAsync**, vous pouvez utiliser les propriétés de l’objet **AsyncResult** pour renvoyer les informations suivantes.



|**Propriété**|**Utiliser pour**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Accéder à i, **tableau** d’objets [CustomXMLNode](../../reference/shared/customxmlnode.customxmlnode.md) qui représentent les nœuds spécifiés par l’expression XPath transmise au paramètre _xPath_.|
