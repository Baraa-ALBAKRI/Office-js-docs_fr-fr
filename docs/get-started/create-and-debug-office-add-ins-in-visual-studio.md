...
4. Visual Studio crée le projet, puis les fichiers associés apparaissent dans l’**Explorateur de solutions**. La page par défaut Home.html s’ouvre dans Visual Studio.
