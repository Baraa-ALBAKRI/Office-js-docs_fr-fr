...
| `borderInlineColor:`|"automatic" \| \<Tous les noms de couleurs prédéfinis\> \| #RRGGBB|S’applique uniquement aux bordures intérieures dans la plage spécifiée. |
...
|**Clé**|**Valeurs**|**Remarques**|
|:-----|:-----|:-----|
| `indentLeft:`|**Number**|Lorsque cette clé est combinée à une valeur de retrait, seule la combinaison suivante est prise en charge :<br/><br/><ul><li><code>alignHorizontal: "left"</code> et <code>indentLeft: \<value\></code></li></ul>|
| `indentRight:`|**Number**|Lorsque cette clé est combinée à une valeur de retrait, seule la combinaison suivante est prise en charge :<br/><br/><ul><li><code>alignHorizontal: "right"</code> et <code>indentRight: \<value\></code></li></ul>|
| `indentDistributed:`|**Number**|Lorsque cette clé est combinée à une valeur de retrait, seule la combinaison suivante est prise en charge :<br/><br/><ul><li><code>alignHorizontal: "distributed"</code> et <code>indentDistributed: \<value\></code></li></ul>|
